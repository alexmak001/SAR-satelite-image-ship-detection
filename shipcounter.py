...
# filepaths
# edit as necessary
clf_fp = "src/models/inshore_offshore_clf_normal_model.pkl"
faster_fp = "src/models/faster300ep.pt"
retina_fp = "src/models/retina300R2.pt"

# google earth engine credential must be downloaded in json formaat
credentials_fp = '.json'
